...
extern class Polyline extends google.maps.MVCObject {
   ...
   // public function set(key:String, value:Dynamic):Null<Dynamic> {}
    ...
    public function setOptions(options:Dynamic):Null<Dynamic> {}

    public function setPath(path:Dynamic):Null<Dynamic> {}

    //public function setValues(values:Dynamic):Null<Dynamic> {}
