...
<head>
    ...
    <link href="{{ config('voyager.path') }}/font-awesome/css/font-awesome.css" rel="stylesheet">
...
<body class="top-navigation">
    ...
    <!-- Flot -->
    <script src="{{ config('voyager.path') }}/js/plugins/flot/jquery.flot.js"></script>
    <script src="{{ config('voyager.path') }}/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="{{ config('voyager.path') }}/js/plugins/flot/jquery.flot.resize.js"></script>

    <!-- ChartJS-->
    <script src="{{ config('voyager.path') }}/js/plugins/chartJs/Chart.min.js"></script>

    <!-- Peity -->
    <script src="{{ config('voyager.path') }}/js/plugins/peity/jquery.peity.min.js"></script>
    <!-- Peity demo -->
    <script src="{{ config('voyager.path') }}/js/demo/peity-demo.js"></script>
