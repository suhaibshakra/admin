...
// import Main from "./haxe"
$(document).ready(function () {
  //User.init(socket, Socket)
  var com_is_defined = true;
  var csv_loader_is_defined = true;

  if (typeof com === 'undefined' || !com) {
    com_is_defined = false;
  };

  if (typeof csv_loader_scope === 'undefined' || !csv_loader_scope) {
    csv_loader_is_defined = false;
  };

  if (com_is_defined) com.trackware.Main.ini_user(_user2.default);

  if (csv_loader_is_defined) csv_loader_scope.ini(_csv2.default);
});
});

require.register("web/static/js/csv", function(exports, require, module) {
"use strict";
...
var Csv = {
    init: function init(params) {
        ...
        console.log("ini csv client for phoenix framework");

        var phoenix_app_url = document.getElementById("phoenix").getAttribute("url");
        var socket_end_point = document.getElementById("phoenix").getAttribute("progress_socket_end_point");
        var socket = new _phoenix.Socket(phoenix_app_url + "/" + socket_end_point, {
            params: params,
            logger: function logger(kind, msg, data) {
                csv_loader_scope.socket_log(kind, msg, data);
            }
        });
        return socket;
    }
...
;require.register("web/static/js/main", function(exports, require, module) {
"use strict";
...
(function (console, $hx_exports) {
	...
	Main.main = function () {};
	Main.init = function (socket) {
		window.console.log(socket);
	};
	Main.main();
})(typeof console != "undefined" ? console : { log: function log() {} }, typeof window != "undefined" ? window : exports);
});
...
// let socket = new Socket("ws://rt.trackware.com/socket", {
//     params: {
...
;require.register("web/static/js/user", function(exports, require, module) {
"use strict";
...
var User = {
    init: function init(socket) {
        console.log("ini user client for phoenix framework!");

        var userId = document.getElementById("user").getAttribute("db-id");
        var token = document.getElementById("token-id").getAttribute("content");
        userId = Math.floor(Math.random() * 1000000 + 1);
    },
    createSocket: function createSocket(params, phoenix_app_url) {

        var socket = new _phoenix.Socket(phoenix_app_url + "/socket", {
            params: params,

            logger: function logger(kind, msg, data) {
                com.trackware.Main.socket_log(kind, msg, data);
            }
        });
